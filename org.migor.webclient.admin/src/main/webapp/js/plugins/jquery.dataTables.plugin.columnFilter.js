...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateDateTimeRangeInput(oTable) {
            ...
            from.datetimepicker({ controlType: myControl, dateFormat: 'yy-mm-dd', timeFormat:'hh:mm:ss' });
            //th.append(from);
            //th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            ...
            to.datetimepicker({ controlType: myControl, dateFormat: 'yy-mm-dd', timeFormat:'hh:mm:ss' });
            var index = i;
            aiCustomSearch_Indexes.push(i);
                ...
                if (aoColumn != null) {
                    ...
                    switch (aoColumn.type) {
                        ...
                        case "date-range":
                            ...
                            break;
                        case "datetime-range":
                            fnCreateDateTimeRangeInput(oTable);
                            break;
                        case "checkbox":
